      ...
      <div className="container-inner mx-auto py-10">
        ...
        <div className="flex justify-center mb-8">
          <div className="relative w-full">
            ...
            {query.length > 0 ? (
              <div
                ...
                className="absolute top-0 right-0 text-2xl mr-3 cursor-pointer text-gray-600 hover:text-gray-800"
                style={{ top: `${2  }px` }}
              >
                &times;
              </div>
          ...
          <div className="text-sm ml-2 self-center">
            <p className="bg-gray-300 rounded-full px-4 py-2 mr-4 hover:bg-green-300">
              {posts.length}
            </p>
          </div>
        </div>
